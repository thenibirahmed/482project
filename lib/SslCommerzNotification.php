...
class SslCommerzNotification extends AbstractSslCommerz
{
     ...
     */
    public function makePayment(array $requestData, $type = 'checkout', $pattern = 'json', $bookingId = null)
    {
    ...
    {
        $this->successUrl = $this->config['projectPath'] . '/' . $this->config['success_url'] . '?booking_id=' . $this->bookingId;
    }
