...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://482lab.test'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'wds5ef32ea060782'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'wds5ef32ea060782@ssl'); // your store password.
}
