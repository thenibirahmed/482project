    ...
    <div class="search-result">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="table-responsive bg-white mb-5 table-bordered rounded table-striped">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" style="color: #666666;" class="w-25">Sajek Premium</th>
                                    <td>12-Mar-2023</td>
                                    <td>DHAKA</td>
                                    <td>SAJEK</td>
                                    <td>7,500</td>
                                    <td><a href="details.php" class="btn btn-dark btn-sm">SEE DETAILS</a></td>
                                    <td><a href="checkout.php" class="btn btn-success btn-sm">BOOK NOW</a></td>
                                </tr>
                                <tr>
                                    <th scope="row" style="color: #666666;" class="w-25">Sajek Premium</th>
                                    <td>12-Mar-2023</td>
